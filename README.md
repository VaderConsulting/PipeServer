...
|---------|----------|------|---------|
| `PipeServer` (`Pipesrv.vbp`) | VB6 | WinForms exe | Chapter 14 - Miscellaneous Examples |
...
Working copy from Dave Robinson's OneDrive Historical Dev folder `VB/Old/PipeServer`.
Company names in project files: Desaware Inc..
